(() => {
  ...
  const IMG = {
    hero: `${ASSET}brand-mockups/goobus-bus-rebrand-hero.png`,
    corporate: `${ASSET}seg-empresas.jpg`,
    tourism: `${ASSET}seg-turismo.jpg`,
    transfers: `${ASSET}seg-aeroportos.jpg`,
    events: `${ASSET}seg-eventos.jpg`,
    schools: `${ASSET}seg-escolas.jpg`,
    pilgrimages: `${ASSET}seg-romarias.jpg`,
    bands: `${ASSET}seg-bandas.jpg`,
    route: `${ASSET}op-planejamento-rota.jpg`,
    safety: `${ASSET}op-inspecao-seguranca.jpg`,
    bus: `${ASSET}frota-real-onibus-convencional-20260606.jpg`,
    executive: `${ASSET}frota-real-onibus-executivo-20260606.jpg`,
    micro: `${ASSET}frota-real-micro-onibus-20260606.jpg`,
    van: `${ASSET}frota-real-van-executiva-20260606.jpg`
  };
  ...
  function header() {
    ...
    return `<a class="skip-link" href="#conteudo">Pular para o conteúdo</a>
      ...
      <header class="site-header"><div class="container site-header__inner">
        <a class="brand" href="/" aria-label="GOOBUS - Página inicial"><img src="/assets/brand/approved/goobus-logo-approved-dark-header.png" alt="GOOBUS" width="715" height="156"></a>
      ...
      <div class="mobile-menu" aria-hidden="true"><div class="mobile-menu__top"><img src="/assets/brand/approved/goobus-logo-approved-dark-header.png" alt="GOOBUS"><button type="button" aria-label="Fechar menu">×</button></div><nav>${navigation}</nav><div class="mobile-menu__actions"><a class="button button--orange" href="/orcamento">Solicitar orçamento</a><a class="button button--outline" href="${wa('Olá! Gostaria de falar com a equipe GOOBUS.')}" target="_blank" rel="noopener noreferrer">${ICON.whatsapp} WhatsApp</a></div></div>`;
  }
  ...
  function render() {
    ...
    document.body.dataset.build = '20260714-5';
